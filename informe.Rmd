...
\begin{itemize}
  \item{1. Identificar cuáles son los géneros de juego más populares en cada ubicación (USA, Europe, Other) para establecer el contexto del mercado. Gráfico de Barras Apiladas

2. Comparar las horas de dedicación y frecuencia de sesiones semanales entre distintos géneros de videojuegos Gráfico de Barras Agrupadas

3. Evaluar la distribución de las horas totales de juego registradas por los usuarios para identificar niveles de dedicación Diagrama de Caja

4. verificar si existe una relación directa entre el tiempo total de juego y la frecuencia semanal (¿quienes juegan más horas, entran más veces?).Gráfico de Dispersión}
\end{itemize}
